...
use App\Http\Requests\Web\Home\UpdateEventRequest;
...
class EventController extends Controller
{
    ...
    public function update(UpdateEventRequest $request)
    {
        try {
            ...
            $section = Section::where('name', 'event')->firstOrFail();
            ...
            return redirect()->back()->with('success', 'Event section updated successfully.');
        } catch (AuthorizationException $authorizationException) {
            Log::error($authorizationException->getMessage());
            abort(403, 'This action is unauthorized.');
        } catch (\Exception $e) {
            Log::error('Failed to update Event section', [
                'error' => $e->getMessage(),
            ...
            return redirect()->back()->with('error', 'Failed to update Event section. ' . $e->getMessage());
        }
    }
}
