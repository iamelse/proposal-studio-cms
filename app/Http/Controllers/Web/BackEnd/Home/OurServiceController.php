...
use App\Http\Requests\Web\Home\UpdateOurServiceRequest;
...
class OurServiceController extends Controller
{
    public function index(): View
    {
        ...
        return view('pages.fe-home.our-service', [
            'title' => 'Home | Our Service',
            'ourService' => $ourService
        ]);
    }

    public function update(UpdateOurServiceRequest $request)
    {
        try {
            ...
            $section = Section::where('name', 'services')->firstOrFail();
            ...
            Log::error('Failed to update Service section', [
                'error' => $e->getMessage(),
            ...
            return redirect()->back()->with('error', 'Failed to update Service section. ' . $e->getMessage());
        }
    }
}
