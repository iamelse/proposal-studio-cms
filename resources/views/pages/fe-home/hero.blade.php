                ...
                <form action="{{ route('be.home.hero.update') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            id="subtitle"
                            value="{{ old('content.subtitle', $content['subtitle'] ?? '') }}"
                            class="mt-2 block w-full rounded-md border px-3 py-2 text-sm @error('content.subtitle') border-red-500 @else border-gray-300 @enderror dark:bg-gray-700 dark:border-gray-600 dark:text-white"
