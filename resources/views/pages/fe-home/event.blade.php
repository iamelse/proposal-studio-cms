    ...
    <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
        ...
        <div class="flex px-6 flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-gray-600 dark:text-gray-400">
                    Enter the main title and description that will appear at the top of the Event section. This content should clearly outline the purpose and key highlights of your event to engage your audience effectively.
                </p>
            </div>
        ...
        <div class="border-gray-100 p-5 dark:border-gray-800 sm:p-6">
            <div class="rounded-2xl px-6 pb-8 pt-4 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                <form action="{{ route('be.home.event.update') }}" method="POST">
                    @csrf
                    @method('PUT')
