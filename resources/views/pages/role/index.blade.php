...
<main>
   <div class="p-4 mx-auto max-w-screen-2xl md:p-6">
    ...
    z-50 overflow-visible">
                                        ...
                                        {{-- Tombol Edit dan Delete hanya muncul jika bukan role MASTER --}}
                                        @if($role->name !== \App\Enums\RoleEnum::MASTER->value)
                                            <a href="{{ route('be.role.and.permission.edit', $role->slug) }}"
                                            ...
                                            <div x-data="{ openRoleDeleteModal: false }">
                                                @can(PermissionEnum::DELETE_ROLE, $roles)
                                                    <button @click="openRoleDeleteModal = true"
                                                            class="block w-full px-4 py-2 text-left text-sm text-red-600 hover:bg-red-100 dark:text-red-400 dark:hover:bg-red-800">
                                                        Delete
                                                    </button>
                                                @endcan
                                        ...
                                        {{-- Tombol Permission tetap selalu tampil --}}
                                        <a href="{{ route('be.role.and.permission.edit.permissions', $role->slug) }}"
                                           class="block w-full px-4 py-2 text-left text-sm text-gray-600 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-800">
                                            Permission
                                        </a>
                                    </div>
