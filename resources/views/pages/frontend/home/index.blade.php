...
@section('clients')
    ...
    <div id="proposal" class="mx-5 my-14 md:mx-10">
        ...
        <div class="mt-8 md:mt-16 flex items-center justify-center gap-5">
            ...
            <!-- Right Arrow -->
            <button id="client-next" class="hidden lg:flex w-8 h-8 bg-white rounded-full boitems-center justify-center hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed">
...
@section('events')
    ...
    <div id="proposal" class="mx-5 my-14 md:mx-10 bg-cover bg-center" style="background-image: url('https://raw.githubusercontent.com/vikifsyh/proposal-studio/main/public/bg2.png')">
        ...
        <div class="mt-8 md:mt-16 flex items-center justify-center gap-5">
            ...
            <!-- Right Arrow -->
            <button id="event-next" class="hidden lg:flex w-8 h-8 bg-white rounded-full boitems-center justify-center hover:bg-gray-100 transition disabled:opacity-50 disabled:cursor-not-allowed">
                <i class='bx bx-right-arrow-alt text-lg'></i>
            </button>
        </div>
    </div>
